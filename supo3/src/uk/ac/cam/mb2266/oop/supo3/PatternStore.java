...
public List<Pattern> getPatternsNameSorted() {
    Collections.sort(patterns, (p1, p2) -> (p1.getName().toLowerCase().compareTo(p2.getName().toLowerCase())));
    List<Pattern> copy = new LinkedList<>(patterns);
    return copy;
}

public List<Pattern> getPatternsAuthorSorted() {
    Collections.sort(patterns, (p1, p2) -> {
...
public List<String> getPatternNames() {
    ...
    Collections.sort(copy, (s1, s2) -> (s1.toLowerCase().compareTo(s2.toLowerCase())));
